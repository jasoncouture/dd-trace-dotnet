...
public class DatadogTagsHeaderTests
{
    ...
    public void Serialize()
    {
        ...
        header.Should().Be(ThreeKeyValuePairs);
    }
    ...
    public void AppendTagValue_UpstreamServices()
    {
        ...
        header.Should().Be("_dd.p.upstream_services=U2VydmljZTE|-1|2|0.9577");
        ...
        header.Should().Be("_dd.p.upstream_services=U2VydmljZTE|-1|2|0.9577;U2VydmljZTI|1|3|0.9077");
    }
}
