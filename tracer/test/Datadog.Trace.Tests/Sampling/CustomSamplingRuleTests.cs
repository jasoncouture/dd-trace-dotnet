...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class CustomSamplingRuleTests
    {
        ...
        private static readonly Span CartCheckoutSpan = new Span(DateTimeOffset.Now, new SpanContext(Id++, Id++, null, serviceName: "shopping-cart-service")) { OperationName = "checkout" };
        private static readonly Span AddToCartSpan = new Span(DateTimeOffset.Now, new SpanContext(Id++, Id++, null, serviceName: "shopping-cart-service")) { OperationName = "cart-add" };
        private static readonly Span ShippingAuthSpan = new Span(DateTimeOffset.Now, new SpanContext(Id++, Id++, null, serviceName: "shipping-auth-service")) { OperationName = "authorize" };
        private static readonly Span ShippingRevertSpan = new Span(DateTimeOffset.Now, new SpanContext(Id++, Id++, null, serviceName: "shipping-auth-service")) { OperationName = "authorize-revert" };
        private static readonly Span RequestShippingSpan = new Span(DateTimeOffset.Now, new SpanContext(Id++, Id++, null, serviceName: "request-shipping")) { OperationName = "submit" };
