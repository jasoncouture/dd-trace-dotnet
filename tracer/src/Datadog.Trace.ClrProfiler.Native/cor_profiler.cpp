                                                 ...
                                                 RejitHandlerModuleMethod* methodHandler)
{
    ...
    {
        original_code =
            GetILCodes("*** CallTarget_RewriterCallback(): Original Code: ", &rewriter, *caller, module_metadata.metadata_import);
    }
    ...
    if (IsDumpILRewriteEnabled())
    {
        ...
        Logger::Info(
            GetILCodes("*** CallTarget_RewriterCallback(): Modified Code: ", &rewriter, *caller, module_metadata.metadata_import));
    }
