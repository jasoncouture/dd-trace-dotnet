// <copyright file="Span.ISpanParent.cs" company="Datadog">
...
namespace Datadog.Trace
{
    ...
    /// </summary>
    internal partial class Span : ISpanParent
    {
        ulong ISpanParent.TraceId => TraceId;

        ulong ISpanParent.SpanId => SpanId;
    }
}
